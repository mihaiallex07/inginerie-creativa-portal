...
vi.mock("./db", () => ({
  ...
  createProject: vi.fn().mockResolvedValue({ id: 1, name: "Test", status: "activ" }),
  updateProject: vi.fn().mockResolvedValue({ id: 1 }),
  deleteProject: vi.fn().mockResolvedValue({ success: true }),
  getProjectDetail: vi.fn().mockResolvedValue(null),
  createProjectFromTemplate: vi.fn().mockResolvedValue({ id: 2 }),
  getProjectPhases: vi.fn().mockResolvedValue([]),
  createPhase: vi.fn().mockResolvedValue({ id: 1 }),
  updatePhase: vi.fn().mockResolvedValue({ id: 1 }),
  ...
  startTaskSession: vi.fn().mockResolvedValue({ id: 1, status: "activa" }),
  pauseTaskSession: vi.fn().mockResolvedValue({ id: 1 }),
  resumeTaskSession: vi.fn().mockResolvedValue({ id: 1 }),
  stopTaskSession: vi.fn().mockResolvedValue({ id: 1 }),
  ...
  createHourRequest: vi.fn().mockResolvedValue({ id: 1 }),
  getHourRequestsForProject: vi.fn().mockResolvedValue([]),
  getMyHourRequests: vi.fn().mockResolvedValue([]),
  reviewHourRequest: vi.fn().mockResolvedValue({ id: 1 }),
