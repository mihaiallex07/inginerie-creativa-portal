...
import { BookOpen, ExternalLink, AlertCircle, FileIcon } from "lucide-react";
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Biblioteca tehnica</h1>
          <p className="text-sm text-gray-400">
            Normative, standarde, detalii tipice, specifice si integrate interne
          </p>
        </div>
      </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex flex-col items-center gap-3 py-8 text-center">
              ...
              <p className="text-sm text-gray-400">
                Nu exista documente in folderul Biblioteca tehnica din Drive.
              </p>
              <p className="text-xs text-gray-600">
                Adauga fisiere in folderul HUB IC / Biblioteca tehnica din Google Drive.
              </p>
            </div>
          ) : (
            <div className="space-y-2">
